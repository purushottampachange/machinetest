...
//  "I want to master [language]"
 ...
 items = ["Milk", "Eggs", "Bread", "Butter", "Coffee", "Rice", "Sugar", "Salt", "Biscuits", "Maggi", "Tea"];

// 
 hobbies = ["Reading", "Gaming", "Drawing", "Singing", "Dancing", "Swimming", "Cooking", "Cycling", "Photography", "Writing"];
...
// Wrap each item in <strong>
 ...
 fruits = ["Apple", "Banana", "Grapes", "Mango", "Orange", "Pineapple", "Watermelon", "Strawberry", "Kiwi", "Papaya"];
...
// Display as href="name" I will study React
 tasks = ["Learn JS", "Build Project", "Practice Daily", "Read Docs", "Watch Tutorials", "Try Challenges", "Learn Node", "Understand APIs", "Test Code", "Write Clean Code"];
